...
df = pd.read_csv('C:/Users/ErwinSiegers/Documents/Clients/NN/sankey/Good Files/DF_LINEAGE_SUPPLIER_STAGE_DWH.csv', sep = '|')
df_labels = pd.read_csv('C:/Users/ErwinSiegers/Documents/Clients/NN/sankey/Good Files/DF_LABELS_SUPPLIER_STAGE_DWH.csv', sep = '|')
...
df_labels['Concat'].values.tolist()
